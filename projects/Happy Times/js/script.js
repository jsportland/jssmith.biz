  ...
  `,
    computed: {
        processedPosts() {
            ...
            // Loop through API results, search multimedia array of each result
            // Find correct media type and format. Add image_url attribute
...
const vm = new Vue({
    ...
    data: {
        ...
        section: 'arts', // set preferred default section
    },
    mounted() {
